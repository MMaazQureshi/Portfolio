...
const socialMediaLinks = {
  ...
  linkedin: "https://github.com/MMaazQureshi",
  gmail: "muhammadmaaz40@gmail.com",
  stackoverflow: "https://stackoverflow.com/users/11251637/muhammad-maaz",
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji("⚡ Provide eye catchy frontend that you love to use"),
    emoji(
      "⚡ Integration of third party services to provide seamless experience to the users"
    )
  ],
...
https://fontawesome.com/icons?d=gallery */
  ...
  softwareSkills: [
    ...
    {
      skillName: "Dptnet and Dotnet Core",
      fontAwesomeClassname: "fab fa-csharp"
    },
    {
      skillName: "nodejs",
  ...
  schools: [
    {
      ...
      logo: require("./assets/images/karachi-university-logo.png"),
  ...
  experience: [
    {
      ...
      company: "Apexchat (BreakThru)",
      companylogo: require("./assets/images/ApexChat-logo.png"),
      date: "June 2018 – Present",
      desc: "Working as a full stack software at Apexchat which is a B2B SAAS chat widget application provider having 18000+ clients & handling thousands of chats daily.",
      descBullets: [
        "Developing front end web application architecture.",
        "Ensuring cross-browser optimization.",
